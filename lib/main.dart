...
void main() async {
  ...
  if (token != null && token.isNotEmpty) {
    ...
    if (userStr != null) {
      try {
        ...
        if (roleField != null &&
            roleField.toString().toLowerCase() == 'admin') {
          isAdmin = true;
          ...
          if (rolesRaw is List) {
            for (final r in rolesRaw) {
              if (r is Map &&
                  r['name'] != null &&
                  r['name'].toString().toLowerCase() == 'admin') {
                isAdmin = true;
                break;
  ...
  runApp(ProviderScope(child: MyApp(initialScreen: SplashScreen(nextScreen: initialScreen))));
}
